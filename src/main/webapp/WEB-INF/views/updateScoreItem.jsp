...
<body>
	<div class="title">학생 성적 수정</div>
	<br>
	<br>

	<div class="container">

		<form method="post" action="/updateScoreItem_result?listId=${get_listId}&itemId=${get_itemId}">
			<table class="button">
				<tr>
					<td align="right"><input type="submit" value="성적 수정 완료"></td>
				</tr>
			</table>
			<table class="content_table">
				...
				<tr>
					...
					<td class="input_content" align="center">
						<input type="number" name="kor" id="kor" min="0" max="100"value="${get_kor}">
					</td>
				</tr>
				<tr>
					<td class="input_category" align="center">영어</td>
					<td class="input_content" align="center">
						<input type="number" name="eng" id="eng" min="0" max="100"value="${get_eng}">
					</td>
				</tr>
				<tr>
					<td class="input_category" align="center">수학</td>
					<td class="input_content" align="center">
						<input type="number" name="mat" id="mat" min="0" max="100" id="mat" value="${get_mat}">
					</td>
				</tr>
			</table>
		</form>
